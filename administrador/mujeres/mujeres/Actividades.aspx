<%@ Page Title="" Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="Actividades.aspx.vb" Inherits="Actividades" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

      <h4>Actividades</h4>                      

                    <h5>Selecciona el tipo de actividad a generar</h5>  
