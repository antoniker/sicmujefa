<%@ Page Title="" Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="Dictaminador.aspx.vb" Inherits="Dictaminador" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <h4>Dictaminación de solicitudes</h4>
    <h5>Elige la solicitud a dictaminar</h5>
